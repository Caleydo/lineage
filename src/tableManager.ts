...
export default class TableManager {
  ...
  private defaultCols: String[] =
    ['RelativeID','KindredID', 'Asthma', 'Bipolar', 'sex', 'deceased', 'suicide', 'gen', 'Age', 'FirstBMI', 'AgeFirstBMI', 'race','cause_death', 'weapon']; //set of default cols to read in, minimizes load time for large files;
